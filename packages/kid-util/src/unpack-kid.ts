...
/**
 * Decodifica dados comprimidos no formato usado pelo jogo Kid Chameleon. Esta função tenta manter a
 * estrutura do código Go original, mas usa técnicas idiomáticas de JavaScript/TypeScript.
 *
